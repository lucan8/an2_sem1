...
$routes = [
    ...
    "hosplive/appointments/index" => ["AppointmentsController", "index"],
    ...
    "hosplive/appointments/get_appointments" => ["AppointmentsController", "getAppointments"],
    ...
    "hosplive/appointments/add_summary" => ["AppointmentsController", "addSummary"],
    "hosplive/appointments/view_summary" => ["AppointmentsController", "viewSummary"],
    ...
    "hosplive/auth/change_password" => ["AuthController", "changePassword"],
