// DFS (+detectare cicluri), BFS 
// Prim, Kruskall - Returneaza muchiile alese si suma greutatilor lor
// Ford-Fulkerson, Edmonds-Karp: return max_flow (optional augmenting paths)
// Dijkstra, Bellman-Ford, Floyd-Warshall
// Sortare topologica
// Graf complementar
//Lista de adiacenta, lista de muchii, matrice de adiacenta
...
public:
    ...
    virtual void createFromEdgeList(ifstream& fin){
...
public:
    ...
    void createFromEdgeList(ifstream& fin) override{
...
int main(){
    ...
    int nr_nodes_left, nr_nodes_right, nr_edges;
    fin >> nr_nodes_left >> nr_nodes_right >> nr_edges;
    
    FlowGraph g(nr_nodes_left, nr_nodes_right, nr_edges);
    g.createFromEdgeList(fin);
    g.edmonds();

    for (const auto& e: g.getEdges()){
        fout << *static_pointer_cast<FlowEdge>(e) << '\n';
    }
